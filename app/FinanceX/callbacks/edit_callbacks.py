...
def update_file_account(n_clicks, file1, file2, file3, file4):
    ...
    #merge new data
        ...
        return log_message,categories.reset_index(), [{"name": i, "id": i} for i in categories.reset_index().columns],account_data.to_dict('records'), [{"name": i, "id": i} for i in account_data.reset_index()]