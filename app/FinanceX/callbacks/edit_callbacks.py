...
from FinanceX.ui.edit_ui import layout_categories, layout_list_global
...
def display_details(active_cell,pivot, dataframe):
        if active_cell:
            ...
            category = df.iloc[row, pivot_table.columns.get_loc('Kategorie')]
            month=col
            ...
            return filtered_df.to_dict('records'),row
        return no_update,''
